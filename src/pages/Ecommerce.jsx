...
const Ecommerce = () => {
  ...
  return (
    <Conteiner>
      ...
      <FirstConteiner>
        <ImageConteiner>
          <ImageTeam src={Ecomm}></ImageTeam>
        </ImageConteiner>
        <TextConteiner>
          <HeaderOne>{t("ecommerce.card1.0")}</HeaderOne>
          <ParagraphOne>{t("ecommerce.card1.1")}</ParagraphOne>
      ...
      <FirstConteiner style={{ flexDirection: "row-reverse" }}>
        <ImageConteiner>
          <ImageTeam src={Safe}></ImageTeam>
        </ImageConteiner>
        <TextConteiner>
          <HeaderOne>{t("ecommerce.card2.0")}</HeaderOne>
          <ParagraphOne>{t("ecommerce.card2.1")}</ParagraphOne>
        </TextConteiner>
      </FirstConteiner>
      <FirstConteiner>
        <ImageConteiner>
          <ImageTeam src={Admin}></ImageTeam>
        </ImageConteiner>
        <TextConteiner>
          <HeaderOne>{t("ecommerce.card3.0")}</HeaderOne>
          <ParagraphOne>{t("ecommerce.card3.1")}</ParagraphOne>
        </TextConteiner>
      </FirstConteiner>
      <CardsConteiner>
        <CardConteiner>
